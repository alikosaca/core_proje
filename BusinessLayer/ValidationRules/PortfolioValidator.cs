...
namespace BusinessLayer.ValidationRules
{
    public class PortfolioValidator : AbstractValidator<Portfolio>
    {
        public PortfolioValidator()
        {
            ...
            RuleFor(x => x.ImageUrl).NotEmpty().WithMessage("Görsel2 alanı boş geçilemez");
            RuleFor(x => x.ImageUrl).NotEmpty().WithMessage("Fiyat alanı boş geçilemez");
            RuleFor(x => x.ImageUrl).NotEmpty().WithMessage("Değer alanı boş geçilemez");
